...
const title_content = [
    ...
    [2,"퍼스널 컬러 진단 웹 사이트 MyTone", "사람들에게 많은 인기를 끌었던 퍼스널 컬러 진단을 OpenCV를 이용해서 웹에서 보다 쉽게 접근하여 진단을 받을 수 있도록 편이성 및 재미를 제공하는 것이 목적이다."],
    [3,"안드로이드 기반 헬스장 관리 애플리케이션", "헬스장 관리를 용이하게 하기 위해 회원 등록 및 관리뿐만 아니라 회원권, PT등 운동 예약 관리까지 구현한 관리자용 애플리케이션이다."],
